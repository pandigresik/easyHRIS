...
class ShiftmentGroupDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hr.shiftment_groups.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ShiftmentGroup $model
    ...
    {
        return 'shiftment_groups_datatable_' . time();
    }
}

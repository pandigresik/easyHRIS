...
class SalaryGroupDetailDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hr.salary_group_details.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\SalaryGroupDetail $model
    ...
    {
        return 'salary_group_details_datatable_' . time();
    }
}

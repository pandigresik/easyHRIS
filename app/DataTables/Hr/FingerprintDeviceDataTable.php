...
class FingerprintDeviceDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'hr.fingerprint_devices.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\FingerprintDevice $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FingerprintDevice $model)
    {
    ...
    {
        return 'fingerprint_devices_datatable_' . time();
    }
}

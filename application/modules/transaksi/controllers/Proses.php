...
class Proses extends MX_Controller
{
    ...
    public function fingerDetail($startDate, $endDate , $nik = []){
        ...
        $dataFinger = convertArr2Key($this->fpm->setOriginalData(TRUE)->fields(['nik','kodeabsensi','tanggalabsensi','absen_time'])->as_array()->get_many_by($whereFilter),'nik','tanggalabsensi',TRUE);

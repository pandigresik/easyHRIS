...
<div class="col-md-9"> 
    {!! Form::text('employee_status', null, ['class' => 'form-control','maxlength' => 1,'maxlength' => 1, 'required' => 'required']) !!}
</div>
</div>
...
<div class="col-md-9"> 
    {!! Form::text('identity_number', null, ['class' => 'form-control','maxlength' => 27,'maxlength' => 27, 'required' => 'required']) !!}
</div>
</div>
...
<div class="col-md-9"> 
    {!! Form::text('identity_type', null, ['class' => 'form-control','maxlength' => 1,'maxlength' => 1, 'required' => 'required']) !!}
</div>
</div>
...
<div class="col-md-9"> 
    {!! Form::text('marital_status', null, ['class' => 'form-control','maxlength' => 1,'maxlength' => 1, 'required' => 'required']) !!}
</div>
</div>

...
<!-- Work Date Field -->
<div class="form-group row mb-3">
    {!! Form::label('work_date', __('models/workshiftGroups.fields.work_date').':', ['class' => 'col-md-3
    col-form-label']) !!}
    <div class="col-md-9">
...
<div class="form-group row mb-3">
    <div class="col-md-9 offset-3">
        {!! Form::button(__('crud.generate'), ['class' => 'btn btn-danger', 'data-target' => '#list_workshift_group', 'data-url' => route('hr.workshiftGroups.generate'), 'data-json' => '{}', 'data-ref' => 'input[name=work_date],select[name="shiftment_group_id"]' ,'onclick' => 'main.loadDetailPage(this,\'get\', function(){ main.initCalendar($(\'form\')) })', 'type' => 'button']) !!}
    </div>

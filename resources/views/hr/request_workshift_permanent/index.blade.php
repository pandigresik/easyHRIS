            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">                        
                        <strong>@lang('models/requestWorkshifts.singular') Permanent</strong>
                    </div>
                    <div class="card-body">
                        <!-- Period Field -->
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('startFrom', null, ['class' => 'form-control datetime', 'data-optiondate' =>
                                json_encode(config('local.datesingle'))]) !!}
                            </div>
                        </div>                                                
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-9 offset-3">
                                {!! Form::button(__('crud.search'), ['class' => 'btn btn-primary','value'=> 1, 'data-url' => route('hr.requestWorkshiftPermanents.index'), 'data-target' => '#list-attendance-report', 'data-ref' => 'select[name=grouping],input[name=period],select[name=payroll_group_period_id],select[name^=employee_id],select[name=grouping_payroll_entity_id]' ,'onclick' => 'main.loadDetailPage(this, \'get\')']) !!}

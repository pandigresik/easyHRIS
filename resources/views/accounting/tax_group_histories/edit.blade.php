...
@section('content')
    ...
    <div class="container-fluid">
         <div class="animated fadeIn">
             ...
             <div class="row">
                 <div class="col-lg-12">
                    {!! Form::model($taxGroupHistory, ['route' => ['accounting.taxGroupHistories.update', $taxGroupHistory->id], 'method' => 'patch']) !!}  
                      <div class="card">                          
                          <div class="card-header">
                              <i class="fa fa-edit fa-lg"></i>
                              <strong>Edit @lang('models/taxGroupHistories.singular')</strong>
                          </div>
                          <div class="card-body">                              
